...
const InputWithCancelButton = ({ onSubmit }: InputProps) => {
   ...
   return (
      <form onSubmit={submit} className="relative w-full">
         <input placeholder="Enter city name" {...register("data")} className="w-full text-wp-18 leading-wp-18 shadow-wp-251 border border-wp-96 py-[10px] pl-5 pr-10 rounded-[4px] focus:outline-none" />
